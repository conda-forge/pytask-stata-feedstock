...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pytask-stata-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pytask-stata-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install pytask-stata
```
...
It is possible to list all of the versions of `pytask-stata` available on your platform:
...
```
pixi search pytask-stata --channel conda-forge
```
